...
const translations = {
  en: {
    ...
    pricing_email_note:
      "After booking, we will send you an email with the specialist details and session information.",
    access_platform_title: "Access to guest speakers per month",
    platform_access_1: "1 session - 29$",
    platform_access_2: "5 sessions - 119$",
    platform_access_3: "10 sessions - 179$",
    access_guest_title: "Access to guest speakers per session",
    guest_access_1: "1 month access - 49$",
    guest_access_2: "6 month access - 199$",
    guest_access_3: "12 month access - 299$",
    pricing_free_note:
      "Mindwise is free to download and use, giving parents access to essential guidance and support at no cost. For deeper learning, we also offer optional paid Special Guest Sessions led by certified specialists, providing expert advice on today’s digital challenges.",
    price_1_title: "Single Session",
    price_1_copy: "One online session with resources, workshops, and specialist advice.",
    price_2_title: "5-Session Package",
    price_2_copy: "Five online sessions with resources, workshops, and specialist advice.",
    price_3_title: "Yearly Access",
    price_3_copy: "Year-round online sessions with resources, workshops, and specialist advice.",
  ...
  fr: {
    ...
    pricing_email_note:
      "Après la réservation, nous vous enverrons un courriel avec les détails du spécialiste et les informations de la session.",
    access_platform_title: "Accès aux invités spécialistes par mois",
    platform_access_1: "1 session - 29$",
    platform_access_2: "5 sessions - 119$",
    platform_access_3: "10 sessions - 179$",
    access_guest_title: "Accès aux invités spécialistes par session",
    guest_access_1: "Accès 1 mois - 49$",
    guest_access_2: "Accès 6 mois - 199$",
    guest_access_3: "Accès 12 mois - 299$",
    pricing_free_note:
      "Mindwise est gratuit à télécharger et à utiliser, offrant aux parents un accès sans frais à des ressources essentielles et du soutien. Pour aller plus loin, nous proposons aussi des sessions spéciales payantes avec des spécialistes, offrant des conseils adaptés aux défis numériques d’aujourd’hui.",
    price_1_title: "Session unique",
    price_1_copy: "Une session en ligne avec des ressources, des ateliers et des conseils de spécialistes.",
    price_2_title: "Forfait 5 sessions",
    price_2_copy: "Cinq sessions en ligne avec des ressources, des ateliers et des conseils de spécialistes.",
    price_3_title: "Accès annuel",
    price_3_copy: "Des sessions en ligne toute l’année avec des ressources, des ateliers et des conseils de spécialistes.",
...
const revealTargets = document.querySelectorAll(
  ".kicker, h1, .subheadline, .hero-copy, .section h2, .section h3, .section p, .feature-card, .price-card, .pricing-chip, .voice-card"
);
