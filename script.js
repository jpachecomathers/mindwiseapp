...
const translations = {
  en: {
    ...
    access_platform_title: "Access to guest sessions (includes specialist sessions only)",
    ...
    guest_access_3: "1 year access - 299$",
  ...
  fr: {
    ...
    access_platform_title: "Accès aux sessions avec spécialistes (sessions uniquement)",
    platform_access_1: "1 session - 29$",
    platform_access_2: "5 sessions - 119$",
    platform_access_3: "10 sessions - 179$",
